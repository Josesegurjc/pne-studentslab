...
if not("Error" in response.keys()):
    if choice == "/":
        ...
        if response["total_species"] < response["limit"]:
            print(colored("The limit chosen is higher than the amount of species, then all species are shown", "green"))
        else:
    ...
    print(colored("Welcome to the DATA ERROR server"))
    print(colored("If you are here is because the data you have entered does not exist in the ensembl", "red"))
